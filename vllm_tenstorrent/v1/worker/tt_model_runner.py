...
from vllm_tenstorrent.model_executor.model_loader.tt_model_loader import TTModelLoader
from vllm_tenstorrent.platform import TTPlatform
from vllm.sequence import IntermediateTensors
from vllm.utils import LayerBlockType
from vllm.v1.kv_cache_interface import AttentionSpec, KVCacheConfig
from vllm.v1.outputs import (EMPTY_MODEL_RUNNER_OUTPUT, LogprobsTensors,
                             ModelRunnerOutput)
from vllm_tenstorrent.v1.worker.tt_input_batch import CachedRequestState, InputBatch
from vllm_tenstorrent.worker.tt_model_runner import (TTModelInput, TTSamplingParams,
                                                     sample_tokens)
...
class TTModelRunner:
    ...
    def __init__(
        ...
        self.override_tt_config = vllm_config.additional_config.get(
    ...
    def initialize_kv_cache(self, kv_cache_config: KVCacheConfig) -> None:
        ...
        if (self.override_tt_config
                and "data_parallel" in self.override_tt_config):
